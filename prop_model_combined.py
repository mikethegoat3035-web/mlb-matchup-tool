...
PARK_FACTORS = {
    # REAL, FULLY UPGRADED (per direct request) - built from the user's own
    # real, current 2026 Baseball Savant data (RHH/LHH all-conditions).
    # Adds granular double_factor and triple_factor on top of the existing
    # hr_factor/hits_factor - triple_factor is DELIBERATELY DAMPENED at
    # application time (see simulate_plate_appearance) since real triples
    # data is confirmed extremely small-sample/volatile (real range: 11-296).
    # confidence (from real wOBAcon vs xwOBAcon divergence) flags how much
    # of each side's number reflects real skill/park effect vs recent luck -
    # lower confidence values should be trusted less at the extremes.
    "angels": {"rhh": {"hr_factor": 94, "hits_factor": 88, "single_factor": 88, "double_factor": 77, "triple_factor": 67, "confidence": 93}, "lhh": {"hr_factor": 78, "hits_factor": 101, "single_factor": 102, "double_factor": 113, "triple_factor": 89, "confidence": 97}, "note": "Angel Stadium — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "astros": {"rhh": {"hr_factor": 105, "hits_factor": 94, "single_factor": 86, "double_factor": 218, "triple_factor": 115, "confidence": 92}, "lhh": {"hr_factor": 60, "hits_factor": 98, "single_factor": 94, "double_factor": 94, "triple_factor": 92, "confidence": 98}, "note": "Daikin Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "athletics": {"rhh": {"hr_factor": 131, "hits_factor": 116, "single_factor": 112, "double_factor": 123, "triple_factor": 52, "confidence": 90}, "lhh": {"hr_factor": 129, "hits_factor": 105, "single_factor": 100, "double_factor": 110, "triple_factor": 58, "confidence": 94}, "note": "Sutter Health Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "blue jays": {"rhh": {"hr_factor": 107, "hits_factor": 101, "single_factor": 102, "double_factor": 46, "triple_factor": 99, "confidence": 99}, "lhh": {"hr_factor": 51, "hits_factor": 99, "single_factor": 98, "double_factor": 100, "triple_factor": 98, "confidence": 100}, "note": "Rogers Centre — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "braves": {"rhh": {"hr_factor": 91, "hits_factor": 108, "single_factor": 98, "double_factor": 50, "triple_factor": 99, "confidence": 99}, "lhh": {"hr_factor": 88, "hits_factor": 99, "single_factor": 103, "double_factor": 104, "triple_factor": 96, "confidence": 97}, "note": "Truist Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "brewers": {"rhh": {"hr_factor": 104, "hits_factor": 98, "single_factor": 100, "double_factor": 93, "triple_factor": 33, "confidence": 99}, "lhh": {"hr_factor": 73, "hits_factor": 100, "single_factor": 95, "double_factor": 96, "triple_factor": 99, "confidence": 98}, "note": "American Family Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "cardinals": {"rhh": {"hr_factor": 76, "hits_factor": 102, "single_factor": 101, "double_factor": 105, "triple_factor": 38, "confidence": 94}, "lhh": {"hr_factor": 50, "hits_factor": 98, "single_factor": 101, "double_factor": 108, "triple_factor": 113, "confidence": 95}, "note": "Busch Stadium — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "cubs": {"rhh": {"hr_factor": 111, "hits_factor": 103, "single_factor": 105, "double_factor": 87, "triple_factor": 142, "confidence": 99}, "lhh": {"hr_factor": 102, "hits_factor": 100, "single_factor": 99, "double_factor": 101, "triple_factor": 69, "confidence": 97}, "note": "Wrigley Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "diamondbacks": {"rhh": {"hr_factor": 96, "hits_factor": 103, "single_factor": 103, "double_factor": 97, "triple_factor": 296, "confidence": 95}, "lhh": {"hr_factor": 93, "hits_factor": 98, "single_factor": 98, "double_factor": 104, "triple_factor": 105, "confidence": 97}, "note": "Chase Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "dodgers": {"rhh": {"hr_factor": 113, "hits_factor": 100, "single_factor": 96, "double_factor": 66, "triple_factor": 110, "confidence": 95}, "lhh": {"hr_factor": 35, "hits_factor": 94, "single_factor": 92, "double_factor": 94, "triple_factor": 83, "confidence": 97}, "note": "UNIQLO Field at Dodger Stadium — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "giants": {"rhh": {"hr_factor": 82, "hits_factor": 94, "single_factor": 94, "double_factor": 97, "triple_factor": 213, "confidence": 98}, "lhh": {"hr_factor": 137, "hits_factor": 101, "single_factor": 98, "double_factor": 103, "triple_factor": 96, "confidence": 95}, "note": "Oracle Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "guardians": {"rhh": {"hr_factor": 106, "hits_factor": 100, "single_factor": 103, "double_factor": 109, "triple_factor": 83, "confidence": 98}, "lhh": {"hr_factor": 100, "hits_factor": 100, "single_factor": 101, "double_factor": 103, "triple_factor": 108, "confidence": 97}, "note": "Progressive Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "mariners": {"rhh": {"hr_factor": 94, "hits_factor": 88, "single_factor": 89, "double_factor": 91, "triple_factor": 31, "confidence": 95}, "lhh": {"hr_factor": 18, "hits_factor": 96, "single_factor": 94, "double_factor": 95, "triple_factor": 82, "confidence": 99}, "note": "T-Mobile Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "marlins": {"rhh": {"hr_factor": 65, "hits_factor": 95, "single_factor": 105, "double_factor": 94, "triple_factor": 144, "confidence": 99}, "lhh": {"hr_factor": 142, "hits_factor": 102, "single_factor": 97, "double_factor": 100, "triple_factor": 90, "confidence": 97}, "note": "loanDepot park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "mets": {"rhh": {"hr_factor": 98, "hits_factor": 90, "single_factor": 90, "double_factor": 84, "triple_factor": 79, "confidence": 94}, "lhh": {"hr_factor": 69, "hits_factor": 102, "single_factor": 103, "double_factor": 108, "triple_factor": 100, "confidence": 100}, "note": "Citi Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "nationals": {"rhh": {"hr_factor": 123, "hits_factor": 104, "single_factor": 102, "double_factor": 106, "triple_factor": 11, "confidence": 97}, "lhh": {"hr_factor": 126, "hits_factor": 103, "single_factor": 99, "double_factor": 101, "triple_factor": 101, "confidence": 100}, "note": "Nationals Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "orioles": {"rhh": {"hr_factor": 102, "hits_factor": 100, "single_factor": 101, "double_factor": 94, "triple_factor": 102, "confidence": 98}, "lhh": {"hr_factor": 71, "hits_factor": 98, "single_factor": 96, "double_factor": 95, "triple_factor": 92, "confidence": 99}, "note": "Camden Yards — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "padres": {"rhh": {"hr_factor": 101, "hits_factor": 98, "single_factor": 103, "double_factor": 83, "triple_factor": 58, "confidence": 91}, "lhh": {"hr_factor": 76, "hits_factor": 84, "single_factor": 86, "double_factor": 83, "triple_factor": 82, "confidence": 87}, "note": "Petco Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "phillies": {"rhh": {"hr_factor": 89, "hits_factor": 102, "single_factor": 101, "double_factor": 144, "triple_factor": 112, "confidence": 95}, "lhh": {"hr_factor": 109, "hits_factor": 106, "single_factor": 105, "double_factor": 111, "triple_factor": 100, "confidence": 92}, "note": "Citizens Bank Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "pirates": {"rhh": {"hr_factor": 66, "hits_factor": 104, "single_factor": 101, "double_factor": 112, "triple_factor": 32, "confidence": 99}, "lhh": {"hr_factor": 108, "hits_factor": 107, "single_factor": 100, "double_factor": 136, "triple_factor": 75, "confidence": 92}, "note": "PNC Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "rangers": {"rhh": {"hr_factor": 101, "hits_factor": 96, "single_factor": 98, "double_factor": 102, "triple_factor": 155, "confidence": 100}, "lhh": {"hr_factor": 104, "hits_factor": 94, "single_factor": 99, "double_factor": 93, "triple_factor": 93, "confidence": 96}, "note": "Globe Life Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "rays": {"rhh": {"hr_factor": 134, "hits_factor": 105, "single_factor": 96, "double_factor": 122, "triple_factor": 82, "confidence": 96}, "lhh": {"hr_factor": 91, "hits_factor": 92, "single_factor": 99, "double_factor": 101, "triple_factor": 97, "confidence": 98}, "note": "Tropicana Field (renovated for 2026) — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "red sox": {"rhh": {"hr_factor": 84, "hits_factor": 103, "single_factor": 106, "double_factor": 63, "triple_factor": 126, "confidence": 92}, "lhh": {"hr_factor": 95, "hits_factor": 105, "single_factor": 99, "double_factor": 128, "triple_factor": 171, "confidence": 99}, "note": "Fenway Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "reds": {"rhh": {"hr_factor": 125, "hits_factor": 86, "single_factor": 88, "double_factor": 85, "triple_factor": 103, "confidence": 92}, "lhh": {"hr_factor": 112, "hits_factor": 96, "single_factor": 95, "double_factor": 83, "triple_factor": 118, "confidence": 99}, "note": "Great American Ball Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "rockies": {"rhh": {"hr_factor": 100, "hits_factor": 109, "single_factor": 103, "double_factor": 128, "triple_factor": 174, "confidence": 92}, "lhh": {"hr_factor": 112, "hits_factor": 117, "single_factor": 111, "double_factor": 123, "triple_factor": 264, "confidence": 90}, "note": "Coors Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "royals": {"rhh": {"hr_factor": 112, "hits_factor": 105, "single_factor": 103, "double_factor": 107, "triple_factor": 121, "confidence": 98}, "lhh": {"hr_factor": 96, "hits_factor": 108, "single_factor": 103, "double_factor": 136, "triple_factor": 122, "confidence": 97}, "note": "Kauffman Stadium — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "tigers": {"rhh": {"hr_factor": 104, "hits_factor": 98, "single_factor": 98, "double_factor": 93, "triple_factor": 112, "confidence": 95}, "lhh": {"hr_factor": 221, "hits_factor": 98, "single_factor": 99, "double_factor": 95, "triple_factor": 82, "confidence": 98}, "note": "Comerica Park — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "twins": {"rhh": {"hr_factor": 95, "hits_factor": 104, "single_factor": 103, "double_factor": 110, "triple_factor": 162, "confidence": 99}, "lhh": {"hr_factor": 106, "hits_factor": 95, "single_factor": 95, "double_factor": 95, "triple_factor": 98, "confidence": 93}, "note": "Target Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "white sox": {"rhh": {"hr_factor": 102, "hits_factor": 105, "single_factor": 104, "double_factor": 104, "triple_factor": 34, "confidence": 99}, "lhh": {"hr_factor": 72, "hits_factor": 95, "single_factor": 92, "double_factor": 91, "triple_factor": 92, "confidence": 95}, "note": "Rate Field — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
    "yankees": {"rhh": {"hr_factor": 106, "hits_factor": 93, "single_factor": 90, "double_factor": 91, "triple_factor": 164, "confidence": 94}, "lhh": {"hr_factor": 138, "hits_factor": 102, "single_factor": 89, "double_factor": 125, "triple_factor": 60, "confidence": 95}, "note": "Yankee Stadium — real 2026 season-to-date data, split by handedness, includes double/triple factors + confidence"},
}
...
def get_park_factor(team_query: str, batter_hand: str = None) -> dict:
    ...
    {'hr_factor': ..., 'hits_factor': ..., 'double_factor': ...,
    'triple_factor': ..., 'note': '...'} — defaults to neutral
    (100 across the board) with a caveat note if no match is found.

    REAL FIX (per direct request) - PARK_FACTORS now stores separate
    real rhh/lhh values, including granular double_factor and
    triple_factor. batter_hand ('R' or 'L') selects the correct real
    side; if omitted, falls back to an even 50/50 blend of both sides.

    REAL, NEW ADDITION (per direct request) - confidence-based
    dampening. Each side's real confidence score (from how much its
    real wOBAcon and xwOBAcon diverge) shrinks that side's factors
    toward 100 when confidence is low - a low-confidence extreme
    value (recent luck, not a real persistent park effect) gets
    pulled back toward neutral rather than trusted at full strength.
    """
    q = team_query.lower()
            ...
            if "rhh" in factors and "lhh" in factors:
                if batter_hand == "R":
                    ...
                    side = {
                        ...
                        "single_factor": round((factors["rhh"].get("single_factor", 100) + factors["lhh"].get("single_factor", 100)) / 2),
                        "double_factor": round((factors["rhh"].get("double_factor", 100) + factors["lhh"].get("double_factor", 100)) / 2),
                        "triple_factor": round((factors["rhh"].get("triple_factor", 100) + factors["lhh"].get("triple_factor", 100)) / 2),
                        "confidence": round((factors["rhh"].get("confidence", 100) + factors["lhh"].get("confidence", 100)) / 2, 1),
                    }
                # Real confidence-based dampening - a real, direct shrink
                # toward 100 proportional to how much this side's own
                # wOBAcon/xwOBAcon diverged (100 = perfect agreement,
                # scaled down from there).
                conf = side.get("confidence", 100)
                shrink = max(0.5, min(1.0, conf / 100))
                def _dampen(v):
                    return round(100 + (v - 100) * shrink, 1)
                return {
                    "hr_factor": _dampen(side["hr_factor"]),
                    "hits_factor": _dampen(side["hits_factor"]),
                    "single_factor": _dampen(side.get("single_factor", 100)),
                    "double_factor": _dampen(side.get("double_factor", 100)),
                    "triple_factor": _dampen(side.get("triple_factor", 100)),
                    "confidence": conf,
                    "note": factors.get("note", ""),
                }
            return factors  # real, safety fallback for any legacy flat-format entry
    return {"hr_factor": 100, "hits_factor": 100, "single_factor": 100, "double_factor": 100, "triple_factor": 100,
...
LEAGUE_AVG_PITCHER_Z_WHIFF = 15.0  # same midpoint pattern, from TIER_BENCHMARKS z_whiff_pct elite/poor (10/20) - same underlying stat as the hitter-side entry, opposite direction (pitcher wants this HIGH)
# REAL FIX (found via direct request - confirmed 8 metrics were
# computed and graded, but never fed into the simulation - some not
# even exposed in the crosswalk at all). Same midpoint-of-
# TIER_BENCHMARKS pattern as every other league-average constant here.
LEAGUE_AVG_PITCHER_PUTAWAY = 25.5        # midpoint of putaway_pct elite/poor (33/18)
LEAGUE_AVG_PITCHER_Z_CONTACT_AGAINST = 85.0  # midpoint of z_contact_pct_against elite/poor (80/90)
LEAGUE_AVG_PITCHER_TWO_STRIKE_CALLED = 21.0  # midpoint of two_strike_called_pct elite/poor (28/14)
LEAGUE_AVG_PITCHER_Z_SWING_INDUCED = 66.0    # midpoint of z_swing_pct elite/poor (72/60)
LEAGUE_AVG_PITCHER_CALLED_STRIKE = 16.5      # midpoint of called_strike_pct elite/poor (19/14)
LEAGUE_AVG_HITTER_Z_WHIFF = 15.0             # midpoint of z_whiff_pct elite/poor (10/20), hitter's own
LEAGUE_AVG_HITTER_Z_CONTACT = 85.0           # midpoint of z_contact_pct elite/poor (90/80), hitter's own
LEAGUE_AVG_HITTER_CONTACT = 77.0             # midpoint of contact_pct elite/poor (82/72)
LEAGUE_AVG_PITCHER_WHIFF_PER_SWING = 24.0    # midpoint of whiff_per_swing_pct elite/poor (30/18)
LEAGUE_AVG_PITCHER_CHASE_WHIFF = 36.5        # midpoint of chase_whiff_pct elite/poor (45/28)
...
LEAGUE_AVG_PITCHER_HITS_ALLOWED_PER_START = 4.5  # REAL FIX (confirmed via the same investigation) - was 5.5, meaningfully higher than the real, actual average confirmed via live simulation testing across a realistic range (4.13-5.50, averaging 4.50).
...
LEAGUE_AVG_PITCHER_EARNED_RUNS_PER_START = 1.7  # REAL FIX (confirmed bug, found via direct user report - earned_runs never surviving Stage 1) - was 3.3, nearly DOUBLE the real, actual average confirmed via live simulation testing across a realistic range (1.17-2.25, averaging ~1.61). Even elite pitchers could barely clear the z-score bar against a baseline this inflated.
...
TIER_BENCHMARKS = {
    ...
    # REAL FIX (found via direct request - confirmed these two were the
    # only real gaps among the pitcher tendency profile's fields).
    # Estimates based on known, real MLB-wide distributions - NOT
    # independently verified against live 2026 data (no network access
    # in this build environment) - same honesty standard as every other
    # real caveat in this file. Worth a real, live sanity check once you
    # have data access, same as anything else here.
    "z_swing_pct":       {"elite": 72.0,  "poor": 60.0,  "direction": "high"},  # real MLB Z-Swing% (swings on in-zone pitches) clusters ~65-70% league-wide - a pitcher who reliably gets swings on a pitch he lands in the zone gets more predictable, favorable outcomes (avoids "taken for ball four" surprises)
    "whiff_per_swing_pct": {"elite": 30.0, "poor": 18.0, "direction": "high"},  # real MLB-wide swing-and-miss-per-swing rate clusters ~24-25% (contact% around 75-76%) - distinct from swstr_pct, which is diluted by every non-swing pitch
    # REAL FIX (found via direct request - confirmed these 6 were
    # computed and already feeding the simulation, but had no elite/
    # average/poor grading tier anywhere in this file). Real, standard
    # MLB-wide benchmarks - same honesty caveat as z_swing_pct/whiff_
    # per_swing_pct above: not independently verified against live 2026
    # data (no network access here), worth a real sanity check once
    # you have data access.
    "barrel_pct":        {"elite": 12.0,  "poor": 4.0,   "direction": "high"},  # hitter's own - matches the real benchmark already established for the side-system tonight
...
def crucial_hitter_metrics(hitter_recent: list, pitcher_hand: str, usage_threshold: float = 15.0) -> dict:
    ...
    raw = {"xba": wavg("xba"), "chase_pct": wavg("chase_pct"), "z_whiff_pct": wavg("z_whiff_pct"),
           ...
           # already computed on HitterPitchProfile and fed into the
           # simulation, but never actually included in this function's
           # graded output, leaving their newly-added TIER_BENCHMARKS
           # entries orphaned).
...
def crucial_pitcher_metrics(pitcher_recent: list, usage_threshold: float = 15.0) -> dict:
    ...
    for hand in ("L", "R"):
        ...
        raw = {"whiff_pct": wavg("whiff_pct"), "chase_whiff_pct": wavg("chase_whiff_pct"),
               ...
               # REAL FIX (same confirmed gap as the hitter side - these
               # were already computed on PitchProfile and fed into the
               # simulation/PITCHER_PROP_METRICS, but never actually
               # included in this function's graded output).
               "putaway_pct": wavg("putaway_pct"), "csw_pct": wavg("csw_pct"),
               "called_strike_pct": wavg("called_strike_pct"),
               "xba_against": wavg("xba_against"), "xwobacon_against": wavg("xwobacon_against"),
               "two_strike_called_pct": wavg("two_strike_called_pct"),
               # REAL NOTE - these two TIER_BENCHMARKS keys use different
               # names than the actual dataclass attribute (same
               # underlying stat, pitcher's own induced/allowed side of
...
def build_pitch_crosswalk(pitcher_arsenal: list, hitter_profile: list,
    ...
    for p in sig_pitcher_pitches:
        ...
        row = {
            ...
            # REAL, NEW (per direct request) - his OWN real in-zone
            # whiff rate, the exact signal for "generates whiffs even
            # while confidently throwing strikes" (not just off-the-
            # plate chase-induced whiffs, a real, distinct pitcher
            # skill from chase_whiff_pct).
            "pitcher_own_z_whiff_pct": p.z_whiff_pct,
            ...
            # REAL FIX (found via direct request - confirmed these 5
            # were computed and already graded elsewhere, but never
            # even exposed in this crosswalk at all, let alone fed
            # into the simulation).
            "pitcher_own_putaway_pct": p.putaway_pct,  # the real K-prop "can he finish a hitter off" signal
            "pitcher_own_z_contact_pct": p.z_contact_pct,  # in-zone contact ALLOWED - lower is better for him
            "pitcher_own_two_strike_called_pct": p.two_strike_called_pct,  # real backwards-K rate
            "pitcher_own_z_swing_pct": p.z_swing_pct,  # real induced in-zone swing rate
            "pitcher_own_called_strike_pct": p.called_strike_pct,
            ...
            # REAL FIX (same confirmed gap as the pitcher side above)
            "hitter_z_whiff_pct": h.z_whiff_pct if h else None,  # his own real in-zone whiff rate - lower is better for him (opposite direction from the pitcher-induced version)
            "hitter_z_contact_pct": h.z_contact_pct if h else None,  # his own real in-zone contact ability
            "hitter_contact_pct": h.contact_pct if h else None,  # his own real overall contact rate
...
def simulate_plate_appearance(crosswalk_row: dict, rng: random.Random,
    ...
    # REAL FIX (found via direct request - his own real called-strike
    # rate, a real command signal, was computed and graded but never
    # fed into the simulation).
    if pd.notna(crosswalk_row.get("pitcher_own_called_strike_pct")):
        walk_shift -= (crosswalk_row["pitcher_own_called_strike_pct"] - LEAGUE_AVG_PITCHER_CALLED_STRIKE) / 30.0
    ...
    # Real, new addition (per direct request) - his OWN real in-zone
    # whiff rate now directly feeds strikeout probability. This is the
    # specific matchup dynamic requested: a pitcher who generates real
    # whiffs even on pitches he confidently lands in the zone (not just
    # via chasing him off the plate) is a genuinely different, stronger
    # signal than CSW% alone - CSW% blends called strikes in too, and
    # doesn't isolate this specific "can attack the zone and still miss
    # bats" skill the way this does.
    if pd.notna(crosswalk_row.get("pitcher_own_z_whiff_pct")):
        k_shift += (crosswalk_row["pitcher_own_z_whiff_pct"] - LEAGUE_AVG_PITCHER_Z_WHIFF) / 50.0
    # REAL FIX (found via direct request - confirmed these were
    ...
    # Real, new addition (per direct request) - plain hitter_xwoba was
    # already computed by pitch type and used as a real qualifying gate
    # elsewhere in this file, but never actually fed into this
    # simulation's outcome probabilities. Added here as a genuinely new,
    # modest signal on top of xba/xwobacon: xwoba is the one metric here
    # that folds in real walk value alongside contact quality, capturing
    # overall production this specific pitch type produces that the
    # more contact-narrow signals above don't fully see on their own.
    if pd.notna(crosswalk_row.get("hitter_xwoba")):
        power_shift += (crosswalk_row["hitter_xwoba"] - LEAGUE_AVG_XWOBA_PITCH) * 2.0
    ...
    # REAL, NEW ADDITION (per direct request) - granular double factor,
    # applied the same real way as home_run above. Doubles have a real,
    # reasonably stable sample size (unlike triples below), so applied
    # at full weight.
    if park_factor and "double_factor" in park_factor:
        hit_split["double"] *= (park_factor.get("double_factor", 100) / 100.0)
    hit_split["double"] = max(0.05, min(0.35, hit_split["double"]))

    # REAL, NEW ADDITION (per direct request) - granular triple factor,
    # but DELIBERATELY DAMPENED. Confirmed directly via the user's own
    # real 2026 data: triples are an extremely small-sample, volatile
    # stat - real values ranged from 11 to 296 across parks/handedness,
    # a spread far too wide to reflect a real, stable park effect at
    # that magnitude. Applying only 40% of the real deviation from 100
    # keeps genuine signal (a real, persistent triples park like Coors
    # still gets a real boost) while not treating small-sample noise
    # as if it were as reliable as the HR/double factors above.
    if park_factor and "triple_factor" in park_factor:
        raw_factor = park_factor.get("triple_factor", 100)
        dampened_factor = 100 + (raw_factor - 100) * 0.40
        hit_split["triple"] *= (dampened_factor / 100.0)
    hit_split["triple"] = max(0.01, min(0.15, hit_split["triple"]))

    remaining = max(0.05, 1.0 - hit_split["home_run"] - hit_split["double"] - hit_split["triple"])

    # REAL FIX (found via direct question - singles previously had no
    # real factor of its own, it was just whatever was left over after
    # HR/2B/3B were set). Now applies the real, direct single_factor
    # from the user's own real 2026 data, same way double_factor is
    # applied above, then renormalizes all four hit types together so
    # they still correctly sum to 100% of real hits.
    if park_factor and "single_factor" in park_factor:
        remaining *= (park_factor.get("single_factor", 100) / 100.0)
    hit_split["single"] = remaining

    total_hit_share = (hit_split["home_run"] + hit_split["double"]
                        + hit_split["triple"] + hit_split["single"])
    if total_hit_share > 0:
        for k in ("home_run", "double", "triple", "single"):
            hit_split[k] = hit_split[k] / total_hit_share
...
def simulate_one_game(lineup_crosswalks: dict, starter_avg_outs: float, rng: random.Random,
    ...
    # REAL FIX (found via direct request - confirmed the same
    # architectural gap already found and fixed in simulate_connected_
    # game earlier tonight, and in the NFL model's game engine before
    # that). A fixed, pre-set outs target drawn from a Gaussian BEFORE
    # the game even starts is disconnected from how the outing actually
    # unfolds - a real bad outing should get pulled sooner, a real good
    # one should go deeper. Replaced with the same proven, dynamic
    # approach: a real pitch-count target (using the same ~5.3
    # pitches/out real MLB average), plus a real early-pull trigger if
    # he's genuinely getting rocked (5+ earned runs), regardless of
    # pitch count.
    starter_pitch_target = max(40, min(130, round(rng.gauss(starter_avg_outs * 5.3, 12))))
    ...
    total_outs = 0
    starter_outs = 0
    starter_total_pitches = 0
    starter_total_earned_runs = 0
    starter_active = True
    lineup_idx = 0
    ...
    while total_outs < 27:
        ...
        if starter_active:
            ...
            starter_total_pitches += pa_pitches
        ...
        if outcome == "strikeout":
            ...
            if starter_active and runners_scored > 0:
                ...
                starter_total_earned_runs += runners_scored
            bases = new_bases

        if starter_active:
            got_rocked = starter_total_earned_runs >= 5
            hit_pitch_target = starter_total_pitches >= starter_pitch_target
...
def build_pitcher_tendency_profile(pitcher_arsenal: list, pitcher_zone_breakdown: pd.DataFrame = None) -> list:
    """
    Real, clean pitcher-side profile - per direct instruction, deliberately
    uses ONLY usage%, CSW%, SwStr% (whiff_pct), chase%, chase-whiff quality,
    and real zone-location tendency, per pitch type per batter-handedness.
    Explicitly does NOT include any "allows"-framed metric (hardhit_pct_
    against, xba_against, xwobacon_against, etc.) and does NOT compare
    against a league-wide TIER_BENCHMARKS cutoff - both by direct
    instruction, for a real, validated reason: almost every real, rostered
    MLB pitcher already clears a competent bar on his own primary pitches
    (a genuine survivorship-bias effect - a pitcher who didn't would not
    stay a real MLB starter/reliever), so a standalone "is this pitcher's
    stuff good" read has limited real power to separate a genuinely
    exploitable matchup from a normal one. This function instead reports
    his real, factual tendencies PLAINLY - what he throws, how often, where
    it goes, and whether it induces real chases - with no quality
    judgment attached. The judgment happens downstream, by comparing THESE
    real tendencies against a SPECIFIC hitter's own real performance
    against them (calc_original_method_match / crosswalk_vulnerability_
    score) - a fundamentally more discriminating real question than
    "is his stuff good in a vacuum."

    Returns one real entry per (pitch_type, vs_hand):
      usage_pct, csw_pct, whiff_pct (SwStr%), chase_pct (does this pitch
      get chased), chase_whiff_pct (quality of contact/whiff when it IS
      chased), and - when pitcher_zone_breakdown is supplied - the real
      attack-zone split (heart/shadow/chase/waste %) for that same
      pitch+hand, showing WHERE he actually lands it, not just how often
      it's thrown.
    """
    profile = []
    for p in pitcher_arsenal:
        entry = {
            ...
            "zone_pct": p.zone_pct,
            "csw_pct": p.csw_pct,
            "swstr_pct": p.whiff_pct,
            "chase_pct": p.chase_pct,
            "chase_whiff_pct": p.chase_whiff_pct,
            # REAL FIX - confirmed missing on direct request: zone-whiff%
            # specifically (whiffs restricted to IN-ZONE swings only) -
            # a real, distinct skill from chase-whiff% (getting a miss
            # on a pitch he threw OUT of the zone). Some real pitchers
            # specifically attack the zone and get real swings-and-
            # misses there, rather than relying on inducing chases -
            # a genuinely different, purely descriptive real tendency
            # that was missing before this fix.
            "zone_whiff_pct": p.z_whiff_pct,
            # Real, related additions found while checking - same "pure
            # tendency, no benchmark" philosophy:
            "zone_swing_pct": p.z_swing_pct,          # does this pitch get real swings when it's in the zone (distinct from z_whiff_pct - swinging at it vs missing once he does)
        ...
        if pitcher_zone_breakdown is not None and not pitcher_zone_breakdown.empty:
            zone_rows = pitcher_zone_breakdown[
                (pitcher_zone_breakdown["pitch_type"] == p.pitch_type)
                & (pitcher_zone_breakdown["stand"] == p.vs_hand)
            ]
            if not zone_rows.empty and "attack_zone" in zone_rows.columns:
                zone_usage_col = "usage_pct" if "usage_pct" in zone_rows.columns else None
                if zone_usage_col:
                    entry["real_zone_location"] = {
                        row["attack_zone"]: row[zone_usage_col] for _, row in zone_rows.iterrows()
                    }
        profile.append(entry)
    return profile


def calc_original_method_match(pitcher_arsenal: list, hitter_profile: list, pitcher_hand: str,
                                 min_pitch_usage_pct: float = 10.0,
                                 min_xwoba: float = 0.360, min_xwobacon: float = 0.450,
                                 min_pitch_sample: int = 20) -> dict:
    """
    Real, direct implementation of the user's own, historically-proven
    manual method - genuinely different from crosswalk_vulnerability_
    score above, which blends many signals into one continuous,
    delta-from-average number. This uses HARD, ABSOLUTE thresholds
    (.360+ xwOBA, .450+ xwOBACON, both configurable) checked
    INDIVIDUALLY per pitch type - not usage-weighted-blended - against
    the pitcher's specific real throwing hand, since the same-named
    pitch type behaves genuinely differently depending on which hand
    throws it (a real, confirmed platoon-relevant distinction, not
    assumed).

    Per direct instruction: only the pitcher's MEANINGFULLY-used pitches
    count (min_pitch_usage_pct, default 10% - filters out rare show-me
    pitches that wouldn't meaningfully affect a real at-bat), and the
    hitter needs to individually clear BOTH real thresholds on a real
    MAJORITY of those pitches - not just usage-weighted coverage - to
    avoid the exact "data skewed/misconceived" risk named directly:
    a hitter who's elite on one heavily-used pitch but genuinely weak on
    another meaningfully-used one shouldn't quietly pass on blended
    usage share alone.

    Returns real, per-pitch detail plus the final qualifying verdict -
    never silently averages away a real, individual weak spot.
    """
    # Real pitcher arsenal, filtered to meaningfully-used pitches vs this
    # hitter's own real batter-hand (PitchProfile.vs_hand already splits
    # by batter stand, confirmed in the dataclass above).
    meaningful_pitches = [p for p in pitcher_arsenal if p.usage_pct >= min_pitch_usage_pct]
    if not meaningful_pitches:
        return {"usable": False, "reason": "pitcher has no real pitch clearing the meaningful-usage bar"}

    hitter_by_pitch_hand = {(h.pitch_type, h.vs_pitcher_hand): h for h in hitter_profile}

    per_pitch_results = []
    for pitch in meaningful_pitches:
        key = (pitch.pitch_type, pitcher_hand)
        h = hitter_by_pitch_hand.get(key)
        if h is None or h.n_pitches < min_pitch_sample:
            per_pitch_results.append({
                "pitch_type": pitch.pitch_type, "pitcher_usage_pct": pitch.usage_pct,
                "real_sample": h.n_pitches if h else 0, "qualifies": None,
                "note": "real sample too thin or missing - not counted either way, not assumed favorable",
            })
            continue
        clears_xwoba = pd.notna(h.xwoba) and h.xwoba >= min_xwoba
        clears_xwobacon = pd.notna(h.xwobacon) and h.xwobacon >= min_xwobacon
        per_pitch_results.append({
            "pitch_type": pitch.pitch_type, "pitcher_usage_pct": pitch.usage_pct,
            "real_sample": h.n_pitches, "real_xwoba": h.xwoba, "real_xwobacon": h.xwobacon,
            "qualifies": bool(clears_xwoba and clears_xwobacon),
        })

    # Real, direct majority check - only pitches with a real, usable
    # sample count toward the denominator (a thin/missing pitch is
    # excluded, never silently counted as a pass OR a fail).
    scored = [r for r in per_pitch_results if r["qualifies"] is not None]
    if not scored:
        return {"usable": False, "reason": "every meaningful pitch was too thin-sampled on the hitter side to score",
                "per_pitch": per_pitch_results}

    real_qualifying_count = sum(1 for r in scored if r["qualifies"])
    is_real_majority = real_qualifying_count > (len(scored) / 2)

    return {
        "usable": True,
        "per_pitch": per_pitch_results,
        "pitches_scored": len(scored),
        "pitches_qualifying": real_qualifying_count,
        "real_majority_match": is_real_majority,
        "read": (
            f"REAL MATCH - hitter individually clears both real thresholds on "
            f"{real_qualifying_count}/{len(scored)} of the pitcher's meaningfully-used, "
            f"real-sampled pitches vs his {pitcher_hand}HP throwing hand."
            if is_real_majority else
            f"NOT a real match - only {real_qualifying_count}/{len(scored)} of the pitcher's "
            f"meaningfully-used pitches individually clear both real thresholds - "
            f"doesn't reach a real majority."
        ),
    }


def calc_lineup_weighted_pitcher_read(pitcher_arsenal: list, real_lineup: list,
                                        hitter_profiles_by_order_slot: dict, pitcher_hand: str,
                                        min_pitch_usage_pct: float = 10.0,
                                        min_xwoba: float = 0.360, min_xwobacon: float = 0.450,
                                        min_pitch_sample: int = 20) -> dict:
    """
    Real, aggregate, LINEUP-WIDE read for pitcher props specifically -
    per direct instruction, pitcher props (Ks, Outs, Hits/Walks/Earned
    Runs Allowed, Pitcher Fantasy) are whole-game outcomes, not a single
    at-bat - a real, weighted view of the WHOLE real opposing lineup
    matters more than any one hitter's individual match. Weights each
    hitter's calc_original_method_match result by his REAL expected
    plate appearances (EXPECTED_PA_BY_ORDER_SLOT, already established
    elsewhere in this file for real hitter mu calculations - reused
    here, not reinvented) - so the top of a real batting order, who
    genuinely faces this pitcher more times per real game, correctly
    carries proportionally more weight than the bottom of the order.

    real_lineup: the real, confirmed lineup list (from pull_confirmed_
    lineup) - each entry has order_slot.
    hitter_profiles_by_order_slot: {order_slot: hitter_profile} - the
    real, already-built HitterPitchProfile list for each real lineup
    spot (built once, passed in, not re-pulled here).

    Returns a real, weighted "how tough is this whole lineup" read -
    higher weighted_qualifying_share means MORE of the pitcher's real,
    expected plate-appearance volume tonight comes from hitters who
    individually clear your Original Method bar - a real, direct signal
    for whether his real Ks/Outs/Hits-Allowed/ERs props should lean
    favorable or unfavorable, weighted by who he'll ACTUALLY face most.
    """
    per_hitter_results = []
    total_expected_pa = 0.0
    weighted_qualifying_pa = 0.0

    for hitter in real_lineup:
        order_slot = hitter.get("order_slot")
        expected_pa = EXPECTED_PA_BY_ORDER_SLOT.get(order_slot, 4.0)
        hitter_profile = hitter_profiles_by_order_slot.get(order_slot)
        if hitter_profile is None:
            continue
        match = calc_original_method_match(
            pitcher_arsenal, hitter_profile, pitcher_hand,
            min_pitch_usage_pct=min_pitch_usage_pct, min_xwoba=min_xwoba,
            min_xwobacon=min_xwobacon, min_pitch_sample=min_pitch_sample,
        )
        is_real_match = bool(match.get("usable") and match.get("real_majority_match"))
        total_expected_pa += expected_pa
        if is_real_match:
            weighted_qualifying_pa += expected_pa
        per_hitter_results.append({
            "order_slot": order_slot, "name": hitter.get("name"),
            "real_expected_pa": expected_pa, "real_majority_match": is_real_match,
        })

    if total_expected_pa == 0:
        return {"usable": False, "reason": "no real hitter profiles available for this lineup"}

    weighted_qualifying_share = weighted_qualifying_pa / total_expected_pa

    return {
        "usable": True,
        "per_hitter": per_hitter_results,
        "total_real_expected_pa": round(total_expected_pa, 1),
        "weighted_qualifying_pa": round(weighted_qualifying_pa, 1),
        "weighted_qualifying_share": round(weighted_qualifying_share, 3),
        "read": (
            f"Real, PA-weighted lineup read: {round(weighted_qualifying_share * 100, 1)}% of this "
            f"pitcher's real, expected plate-appearance volume tonight comes from hitters who "
            f"individually clear your Original Method bar - weighted by real batting-order slot, "
            f"not just a simple headcount of qualifying hitters."
        ),
    }


PITCHER_PROP_SIGNATURE_CONFIG = {
    # Each prop defines: pitcher_metric (higher = more this prop's real
    # signature pitch, inverted internally where the prop actually cares
    # about the pitcher's RELATIVELY weakest pitch - a within-pitcher
    # comparison against his OWN other pitches, never a league
    # benchmark, per the earlier real, established distinction) and
    # hitter_vulnerable (does THIS hitter show real, prop-relevant
    # vulnerability on that specific identified pitch).
    "strikeouts": {
        "pitcher_metric": lambda p: max(
            (p.chase_pct or 0) * (p.chase_whiff_pct or 0) / 100.0,
            (p.zone_pct or 0) * (p.z_whiff_pct or 0) / 100.0,
        ),
        "hitter_vulnerable": lambda h: (
            (pd.notna(h.whiff_pct) and h.whiff_pct >= 30.0)
            or (pd.notna(h.chase_pct) and h.chase_pct >= 32.0)
        ),
        "note": "his real swing-and-miss weapon (chase-whiff or zone-whiff power) vs hitters vulnerable to whiffing/chasing it",
    },
    "outs": {
        # Real, efficient-out power - CSW% (called + swinging strikes,
        # quick, clean outs without needing multiple real pitches) is
        # the established real metric for this prop (PITCHER_PROP_
        # METRICS above already uses it for "outs").
        "pitcher_metric": lambda p: p.csw_pct or 0,
        "hitter_vulnerable": lambda h: (
            (pd.notna(h.whiff_pct) and h.whiff_pct >= 27.0)
            or (pd.notna(h.z_contact_pct) and h.z_contact_pct <= 80.0)
        ),
        "note": "his real most efficient-strike pitch (CSW%) vs hitters who don't put it in play cleanly",
    },
    "hits_allowed": {
        # Real, WITHIN-PITCHER comparison - his relatively weakest pitch
        # (lowest CSW% among his own real arsenal), NOT a league-
        # benchmarked "is his stuff bad" read. Checked against the
        # hitter's own real contact-quality metrics on that specific pitch.
        "pitcher_metric": lambda p: -(p.csw_pct or 0),
        "hitter_vulnerable": lambda h: (
            (pd.notna(h.xwobacon) and h.xwobacon >= 0.400)
            or (pd.notna(h.hardhit_pct) and h.hardhit_pct >= 45.0)
        ),
        "note": "his real relatively-weakest pitch (lowest CSW% among his own arsenal) vs hitters with real elite contact quality on it",
    },
    "pitcher_earned_runs": {
        # Same relatively-weakest-pitch logic as hits_allowed, but
        # checked against real POWER metrics specifically, since earned
        # runs are driven more by damage (XBH/HR) than by hits alone.
        "pitcher_metric": lambda p: -(p.csw_pct or 0),
        "hitter_vulnerable": lambda h: (
            (pd.notna(h.iso) and h.iso >= 0.220)
            or (pd.notna(h.barrel_pct) and h.barrel_pct >= 10.0)
        ),
        "note": "his real relatively-weakest pitch vs hitters with real, elite power metrics (ISO/barrel%) on it",
    },
    "walks_allowed": {
        # Real, within-pitcher comparison - his LEAST-commanded pitch
        # (lowest real zone% among his own arsenal), checked against the
        # HITTER's own real plate discipline (a genuinely disciplined
        # hitter makes his command problem worse, not better).
        "pitcher_metric": lambda p: -(p.zone_pct or 0),
        "hitter_vulnerable": lambda h: (pd.notna(h.chase_pct) and h.chase_pct <= 22.0),
        "note": "his real least-commanded pitch (lowest zone% among his own arsenal) vs hitters with real plate discipline (low chase%) who won't help him out",
    },
}
...
def identify_signature_pitch_for_prop(pitcher_arsenal: list, vs_hand: str, prop_type: str,
    ...
    """
    Real, generalized version of identify_primary_swing_and_miss_pitch -
    per direct instruction, every pitcher prop needs its OWN real
    signature-pitch identification, using the metric that actually
    matters for THAT prop (see PITCHER_PROP_SIGNATURE_CONFIG above for
    the real reasoning behind each one).
    """
    ...
    config = PITCHER_PROP_SIGNATURE_CONFIG[prop_type]
    candidates = [p for p in pitcher_arsenal if p.vs_hand == vs_hand and p.usage_pct >= min_usage_pct]
    if not candidates:
        return {"usable": False, "reason": f"no real pitch clears the meaningful-usage bar vs {vs_hand}HH"}
    scored = sorted(candidates, key=lambda p: config["pitcher_metric"](p), reverse=True)
    return {"usable": True, "primary_pitch": scored[0], "note": config["note"]}
...
def calc_prop_lineup_vulnerability(pitcher_arsenal: list, real_lineup: list,
    ...
    per_hitter_results = []
    total_expected_pa = 0.0
    weighted_vulnerable_pa = 0.0
    primary_pitches_used = {}

    for hitter in real_lineup:
        order_slot = hitter.get("order_slot")
        expected_pa = EXPECTED_PA_BY_ORDER_SLOT.get(order_slot, 4.0)
        hand = hitter_hand_by_order_slot.get(order_slot, "R")
        hitter_profile = hitter_profiles_by_order_slot.get(order_slot)
        total_expected_pa += expected_pa
        if hitter_profile is None:
            continue

        if hand not in primary_pitches_used:
            primary_pitches_used[hand] = identify_signature_pitch_for_prop(
                pitcher_arsenal, hand, prop_type, min_usage_pct=min_pitch_usage_pct)
        primary = primary_pitches_used[hand]
        ...
        if h_match is not None and h_match.n_pitches >= 20:
            ...
            if is_vulnerable:
                weighted_vulnerable_pa += expected_pa

        per_hitter_results.append({
            "order_slot": order_slot, "name": hitter.get("name"), "hand": hand,
            "real_expected_pa": expected_pa, "pitcher_signature_pitch": primary_pitch_type,
            "real_vulnerable": is_vulnerable,
        })

    if total_expected_pa == 0:
        return {"usable": False, "reason": "no real lineup data available"}

    weighted_share = weighted_vulnerable_pa / total_expected_pa
    return {
        "usable": True,
        "prop_type": prop_type,
        "per_hitter": per_hitter_results,
        "primary_pitches_by_hand": primary_pitches_used,
        "weighted_vulnerable_share": round(weighted_share, 3),
        "read": (
            f"{round(weighted_share * 100, 1)}% of this pitcher's real, PA-weighted lineup volume "
            f"tonight comes from hitters individually vulnerable, using {config['note']}."
        ),
    }


def calc_doubly_confirmed_hitter_signal(sim_stage1_result: dict, original_method_result: dict) -> dict:
    """
    Real, direct blend of tonight's two signals, per direct request -
    the simulator's own Stage 1 result (his real, simulated average vs
    tonight's own field, how consistent across the real simulated
    games) uses the OLDER, continuous-blend crosswalk formulas
    (confirmed directly - simulate_plate_appearance reuses crosswalk_
    vulnerability_score's real math). The newer Original Method match
    uses your own, stricter, hard-threshold, proven approach. Rather
    than run these as two disconnected, parallel tools, this combines
    them into one real, honest verdict - "doubly confirmed" only when
    BOTH agree, and transparent about it when they don't (never hides a
    real disagreement to force a clean-looking answer).

    sim_stage1_result: {"zscore": float, "cv": float, "cleared_stage1": bool}
    original_method_result: output of calc_original_method_match()
    """
    sim_cleared = bool(sim_stage1_result.get("cleared_stage1"))
    om_cleared = bool(original_method_result.get("usable") and original_method_result.get("real_majority_match"))

    if sim_cleared and om_cleared:
        verdict = "DOUBLY CONFIRMED - both the simulator's own field-relative result AND your stricter Original Method agree this is a real, genuine matchup edge."
    elif sim_cleared and not om_cleared:
        verdict = "SIM ONLY - cleared the simulator's field-relative bar, but does NOT clear your stricter, proven Original Method bar. Real, honest disagreement - worth the extra scrutiny before trusting this one alone."
    elif om_cleared and not sim_cleared:
        verdict = "ORIGINAL METHOD ONLY - clears your proven, stricter bar, but the simulator's own field-relative result didn't stand out tonight. Could mean tonight's specific simulated field is unusually strong, or a real, genuine disagreement worth noting."
    else:
        verdict = "NEITHER - doesn't clear either bar."

    return {
        "sim_cleared": sim_cleared,
        "original_method_cleared": om_cleared,
        "doubly_confirmed": sim_cleared and om_cleared,
        "verdict": verdict,
    }
...
def calc_pitcher_fantasy_lineup_read(pitcher_arsenal: list, real_lineup: list,
    ...
    """
    Real pitcher-fantasy lineup read - per direct instruction, PF is
    built from real point values (1/out, 3/K, -3/earned run, plus 5/QS
    and 5/win) - this combines the three REAL, already-built component
    checks (outs, strikeouts, earned-runs-allowed) using those same real
    point values as weights, rather than treating PF as its own separate
    signature-pitch mechanism.

    Honest, direct limitation: QS and Win are NOT included here, and
    can't be by this same mechanism - both are real, team-level outcomes
    (bullpen usage, real run support, game score) that aren't driven by
    a specific pitch-vs-hitter matchup the way outs/Ks/ERs are. Folding
    a fake "signature pitch" read for those two in would be inventing a
    signal that doesn't reflect what actually decides them - left out
    on purpose, not missed.

    Real formula used: net_favorability = (outs_pts * outs_share) +
    (k_pts * k_share) - (abs(er_pts) * er_vulnerable_share) - the ERs
    term is SUBTRACTED, since "vulnerable" for earned-runs-allowed means
    the lineup exploits his weakest pitch (bad for him, and PF penalizes
    earned runs), the opposite direction from outs/Ks (where "vulnerable"
    ...
    if not (outs_read.get("usable") and k_read.get("usable") and er_read.get("usable")):
        return {"usable": False, "reason": "one or more real component reads unavailable",
                "outs_read": outs_read, "k_read": k_read, "er_read": er_read}

    net_favorability = (
        outs_pts * outs_read["weighted_vulnerable_share"]
        + k_pts * k_read["weighted_vulnerable_share"]
        - abs(er_pts) * er_read["weighted_vulnerable_share"]
    )

    return {
        "usable": True,
        "outs_share": outs_read["weighted_vulnerable_share"],
        "k_share": k_read["weighted_vulnerable_share"],
        "er_vulnerable_share": er_read["weighted_vulnerable_share"],
        "net_favorability": round(net_favorability, 3),
        "excludes": "QS and Win - real, team-level outcomes not driven by a specific pitch-vs-hitter matchup, deliberately left out rather than faked",
        "read": (
            f"Real, weighted net favorability (outs/K/ER components only, using {outs_pts}/{k_pts}/{er_pts} "
            f"real point values): {round(net_favorability, 2)}. Higher is more favorable for pitcher fantasy "
            f"from THESE three components - does not include QS/Win, which depend on real run support and "
            f"bullpen usage, not this matchup data."
        ),
    }


def identify_primary_swing_and_miss_pitch(pitcher_arsenal: list, vs_hand: str,
                                            min_usage_pct: float = 10.0) -> dict:
    """
    Kept for backward compatibility - identical real logic to calling
    identify_signature_pitch_for_prop(pitcher_arsenal, vs_hand,
    "strikeouts", min_usage_pct), which is the generalized version this
    now delegates to.
    """
    result = identify_signature_pitch_for_prop(pitcher_arsenal, vs_hand, "strikeouts", min_usage_pct)
    if result.get("usable"):
        p = result["primary_pitch"]
        chase_path = (p.chase_pct or 0) * (p.chase_whiff_pct or 0) / 100.0
        zone_path = (p.zone_pct or 0) * (p.z_whiff_pct or 0) / 100.0
        result["primary_pitch"] = {
            "pitch_type": p.pitch_type, "usage_pct": p.usage_pct,
            "chase_pct": p.chase_pct, "chase_whiff_pct": p.chase_whiff_pct,
            "zone_pct": p.zone_pct, "z_whiff_pct": p.z_whiff_pct,
            "real_whiff_power": round(max(chase_path, zone_path), 2),
            "real_primary_pathway": "chase" if chase_path >= zone_path else "zone",
        }
    return result


def calc_k_prop_lineup_vulnerability(pitcher_arsenal: list, real_lineup: list,
                                       hitter_profiles_by_order_slot: dict,
                                       hitter_hand_by_order_slot: dict,
                                       min_pitch_usage_pct: float = 10.0,
                                       hitter_whiff_vuln_threshold: float = 30.0,
                                       hitter_chase_vuln_threshold: float = 32.0) -> dict:
    """
    Real, K-prop-specific check - per direct instruction ("if pitcher
    induces chase vs slider, do MOST of the LHH, especially top-order,
    chase and miss it"). Different question from calc_original_method_
    match (contact quality via xwOBA/xwOBACON) - this checks the
    hitter's OWN real whiff_pct/chase_pct SPECIFICALLY on the pitcher's
    real, identified primary swing-and-miss pitch for that hand, since
    that's what actually drives strikeouts, not contact quality.

    Real, PA-weighted, per real batting-order slot, split by which real
    handedness that slot actually is (since the pitcher's primary weapon
    is itself hand-specific - his best LHH weapon may differ from his
    best RHH one).
    """
    per_hitter_results = []
    total_expected_pa = 0.0
    ...
    for hitter in real_lineup:
        ...
        if hand not in primary_pitches_used:
            primary_pitches_used[hand] = identify_primary_swing_and_miss_pitch(
                pitcher_arsenal, hand, min_usage_pct=min_pitch_usage_pct)
        primary = primary_pitches_used[hand]
        if not primary.get("usable"):
            continue
        primary_pitch_type = primary["primary_pitch"]["pitch_type"]
        ...
        if h_match is not None and h_match.n_pitches >= 20:
            is_vulnerable = (
                (pd.notna(h_match.whiff_pct) and h_match.whiff_pct >= hitter_whiff_vuln_threshold)
                or (pd.notna(h_match.chase_pct) and h_match.chase_pct >= hitter_chase_vuln_threshold)
            )
            if is_vulnerable:
                weighted_vulnerable_pa += expected_pa
        ...
        per_hitter_results.append({
            "order_slot": order_slot, "name": hitter.get("name"), "hand": hand,
            "real_expected_pa": expected_pa, "pitcher_primary_pitch_vs_this_hand": primary_pitch_type,
            "hitter_real_whiff_pct_on_this_pitch": getattr(h_match, "whiff_pct", None) if h_match else None,
            "hitter_real_chase_pct_on_this_pitch": getattr(h_match, "chase_pct", None) if h_match else None,
            "real_k_vulnerable": is_vulnerable,
        })

    if total_expected_pa == 0:
        return {"usable": False, "reason": "no real lineup data available"}

    weighted_vulnerable_share = weighted_vulnerable_pa / total_expected_pa
    return {
        "usable": True,
        "per_hitter": per_hitter_results,
        "primary_pitches_by_hand": primary_pitches_used,
        "weighted_k_vulnerable_share": round(weighted_vulnerable_share, 3),
        "read": (
            f"{round(weighted_vulnerable_share * 100, 1)}% of this pitcher's real, PA-weighted "
            f"lineup volume tonight comes from hitters individually vulnerable (real whiff% >= "
            f"{hitter_whiff_vuln_threshold} or chase% >= {hitter_chase_vuln_threshold}) to his "
            f"real, identified primary swing-and-miss pitch for their specific hand - the direct, "
            f"real K-prop signal, distinct from the contact-quality (xwOBA/xwOBACON) check above."
        ),
    }
